...
import com.llmintentions.notify.databinding.ItemLogBinding
    ...
    fun show(context: Context) {
        ...
        if (entries.isEmpty()) {
            ...
            for (entry in entries) {
                ...
                binding.logSource.setTextColor(ContextCompat.getColor(context,
                ...
                if (entry.isError) binding.logResultPreview.setTextColor(ContextCompat.getColor(context, R.color.status_red))
